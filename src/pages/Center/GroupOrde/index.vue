        ...
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="(order,index) in orderList.records" :key="order.id">
                    ...
                    <tbody>
                        <tr v-for="(List,index) in order.orderDetailList" :key="index">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="List.imgUrl" style="width:100px"/>
...
export default {
    ...
    methods: {
        async getOrderList(){
            let result = await this.$API.getOrderLimit(this.page,this.limit);
            console.log(result);
            if(result.code == 200){
