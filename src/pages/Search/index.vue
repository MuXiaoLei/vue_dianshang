                    ...
                    <ul class="fl sui-tag">       
                        ...
                        <li class="with-x" v-if="searchParams.keyword">{{searchParams.keyword}}
                         ...
                         <li class="with-x" v-if="searchParams.trademark">{{searchParams.trademark.split(':')[1]}}
                            <i @click="moveTrademark">×</i>
                        </li>
                        <li class="with-x" v-for="(propsValue,index) in searchParams.props" :key="index">{{propsValue.split(':')[1]}}
                            <i @click="moveProps(index)">×</i>
                        </li>
                    </ul>
                </div>
                <!--selector-->
